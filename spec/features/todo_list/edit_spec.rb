...
describe 'Editing todo lists' do
	...
	it 'updates a todo list title sucessfully with correct information' do
	...
	it 'updates a todo list description sucessfully with correct information' do
		update_todo_list todo_list: todo_list, description: 'New description'
		todo_list.reload
